  ...
  return (
    <div className="w-full  pt-8 pb-16 flex-col justify-start items-start flex ">
      <div className=" border-t-4 border-b-4 border-gray-200 w-full ">
        <div className="h-[247.16px] max-w-[1024px] mx-auto pt-[30px] pb-14 flex-col justify-start items-center gap-[34px] flex">
      ...
      <div className="bg-neutral-50 w-full py-24">
        <div className="max-w-[1024px] mx-auto">
          ...
          <div className="justify-start items-start gap-10 mt-12 flex">
            <div className="w-[306.66px] h-[202.56px] relative">
              <img
              ...
              <div className="w-[306.66px] pl-[7.80px] pr-[7.86px] left-0 top-[112.18px] absolute justify-center items-start inline-flex">
              ...
              <div className="left-[87.94px] top-[182.56px] absolute text-center text-blue-500 text-base font-semibold">
                View live-feed →
              </div>
            </div>
            <div className="w-[306.67px] h-[202.56px] relative">
              <img
                className="w-[64.97px] h-[63px] left-[120.84px] top-0 absolute"
                src={Public2}
              />
              <div className="left-[72.40px] top-[78px] absolute text-center text-zinc-800 text-lg font-bold leading-relaxed">
                We show our work
              </div>
              <div className="w-[306.67px] pl-[8.51px] pr-[10.16px] left-0 top-[112.18px] absolute justify-center items-start inline-flex">
                <div className="text-center text-zinc-800 text-lg font-medium leading-relaxed">
              ...
              <div className="left-[98.37px] top-[182.56px] absolute text-center text-blue-500 text-base font-semibold">
                View report →
              </div>
            </div>
            <div className="w-[306.67px] h-[202.56px] relative">
              ...
              <div className="w-[306.67px] pl-[19.28px] pr-[18.39px] left-0 top-[112.18px] absolute justify-center items-start inline-flex">
                <div className="text-center text-zinc-800 text-lg font-medium leading-relaxed">
              ...
              <div className="left-[90.89px] top-[182.56px] absolute text-center text-blue-500 text-base font-semibold">
                View receipts →
              </div>
            </div>
          </div>
