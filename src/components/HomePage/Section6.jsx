    ...
    <div className="w-full justify-start items-start">
      <div className="w-full p-[60px] bg-neutral-50 flex-col justify-start items-center gap-[30px] sm:hidden lg:flex ">
        <div className="w-[500px] h-[115.59px] relative">
          ...
          <div className="left-[18.89px] top-[56.59px] absolute text-center text-zinc-800 text-4xl font-semibold leading-[48px]">
            countries love using Wren!
          </div>
        </div>
        <div className="w-[1740px] h-[430.39px] relative">
          <div className="left-[749.75px] top-[408px] absolute text-center text-neutral-400 text-base font-normal leading-snug">
            Click on a face to read a review.
          </div>
          <div className="w-[1710px] h-[400px] left-0 top-0 absolute">
            <img
              className="w-[66px] h-[66px] left-[85.50px] top-[80px] absolute rounded-[66px] shadow"
            ...
            <img
              className="w-16 h-16 left-[427.50px] top-[156px] absolute rounded-[64px]"
              src="https://via.placeholder.com/64x64"
            />
            <img
              className="w-[66px] h-[66px] left-[598.50px] top-[136px] absolute rounded-[66px]"
              src="https://via.placeholder.com/66x66"
            />
            <img
              className="w-[50px] h-[50px] left-[769.50px] top-[80px] absolute rounded-[50px]"
              src="https://via.placeholder.com/50x50"
            />
            <img
              className="w-16 h-16 left-[940.50px] top-[144px] absolute rounded-[64px]"
              src="https://via.placeholder.com/64x64"
            />
            <img
              className="w-[66px] h-[66px] left-[1111.50px] top-[92px] absolute rounded-[66px]"
              src="https://via.placeholder.com/66x66"
            />
            <img
              className="w-[50px] h-[50px] left-[1282.50px] top-[120px] absolute rounded-[50px]"
              src="https://via.placeholder.com/50x50"
            />
            <img
              className="w-16 h-16 left-[1453.50px] top-[80px] absolute rounded-[64px]"
              src="https://via.placeholder.com/64x64"
            />
            <img
              className="w-[66px] h-[66px] left-[1624.50px] top-[120px] absolute rounded-[66px]"
              src="https://via.placeholder.com/66x66"
            />
            <img
              className="w-[50px] h-[50px] left-[171px] top-[200px] absolute rounded-[50px]"
              src="https://via.placeholder.com/50x50"
            />
            <img
              className="w-16 h-16 left-[478.80px] top-[260px] absolute rounded-[64px]"
              src="https://via.placeholder.com/64x64"
            />
            <img
              className="w-[66px] h-[66px] left-[649.80px] top-[212px] absolute rounded-[66px]"
              src="https://via.placeholder.com/66x66"
            />
            <img
              className="w-[50px] h-[50px] left-[820.80px] top-[256px] absolute rounded-[50px]"
              src="https://via.placeholder.com/50x50"
            />
            <img
              className="w-16 h-16 left-[991.80px] top-[224px] absolute rounded-[64px]"
              src="https://via.placeholder.com/64x64"
            />
            <img
              className="w-[66px] h-[66px] left-[1162.80px] top-[240px] absolute rounded-[66px]"
              src="https://via.placeholder.com/66x66"
            />
            <img
              className="w-[50px] h-[50px] left-[1333.80px] top-[212px] absolute rounded-[50px]"
              src="https://via.placeholder.com/50x50"
            />
            <img
              className="w-16 h-16 left-[1504.80px] top-[264px] absolute rounded-[64px]"
              src="https://via.placeholder.com/64x64"
            />
            <img
              className="w-[66px] h-[66px] left-[85.50px] top-[80px] absolute rounded-[66px]"
              src="https://via.placeholder.com/66x66"
            />
            <img
              className="w-[50px] h-[50px] left-[342px] top-[280px] absolute rounded-[50px]"
              src="https://via.placeholder.com/50x50"
            />
          </div>
          <div className="w-[350px] h-[350px] left-[695px] top-[20px] absolute bg-white rounded border border-zinc-900">
            <img
              className="w-[60px] h-[60px] left-[137.50px] top-[27px] absolute rounded-[60px]"
            ...
            <div className="h-[135.95px] pl-[0.08px] left-[27px] top-[160.79px] absolute flex-col justify-start items-center gap-[0.95px] inline-flex">
              <div className="text-center text-zinc-800 text-base font-normal leading-snug">
                “New company but seems incredibly
                <br />
                transparent and realistic. Looked into
                <br />
                other carbon offsets and felt they
                <br />
                were just doing lip service [...] Wren
                <br />
                feels real, with obvious,
              </div>
              <div className="text-center text-zinc-800 text-base font-normal leading-snug">
                researchable, meaningful offsets.”
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full p-[60px] bg-neutral-50 flex-col justify-start items-center gap-[30px] sm:hidden md:flex lg:hidden">
        ...
        <div className="w-[648px] h-[430.39px] relative">
          <div className="left-[203.75px] top-[408px] absolute text-center text-neutral-400 text-base font-normal leading-snug">
            Click on a face to read a review.
          </div>
          ...
          <div className="w-[350px] h-[350px] left-[149px] top-[20px] absolute bg-white rounded border border-zinc-900">
            ...
            <div className="left-[27px] top-[161.78px] absolute flex-col justify-center items-center gap-px inline-flex">
              <div className="text-center text-zinc-800 text-base font-normal leading-snug">
                “New company but seems incredibly
                <br />
                transparent and realistic. Looked into
                <br />
                other carbon offsets and felt they were
                <br />
                just doing lip service [...] Wren feels
                <br />
                real, with obvious, researchable,
              </div>
              <div className="text-center text-zinc-800 text-base font-normal leading-snug">
                meaningful offsets.”
              </div>
      ...
      <div className="w-full bg-neutral-50 h-[741.59px] justify-start items-start sm:flex md:hidden">
        <div className="max-w-[320px] mx-auto py-[50px] pb-[49.99px]  flex-col justify-start items-center flex">
          ...
          <div className="w-[430px] h-[624px] relative">
            <div className="left-[101.27px] top-[233px] absolute text-center text-neutral-400 text-[15px] font-normal leading-[21px]">
              Click on a face to read a review.
            </div>
            ...
            <div className="w-[350px] h-[350px] left-[40px] top-[274px] absolute bg-white rounded border border-zinc-900">
              <img
                className="w-[60px] h-[60px] left-[145px] top-[27px] absolute rounded-[60px]"
                src="https://via.placeholder.com/60x60"
              />
              ...
              <div className="h-[126px] pl-[4.70px] pr-[4.30px] left-[27px] top-[159px] absolute flex-col justify-start items-center inline-flex">
                <div className="text-center text-zinc-800 text-[15px] font-normal leading-[21px]">
                  ...
                  other carbon offsets and felt they were
                  <br />
                  just doing lip service [...] Wren feels real,
                  <br />
                  with obvious, researchable, meaningful
                </div>
                <div className="text-center text-zinc-800 text-[15px] font-normal leading-[21px]">
                  offsets.”
                </div>
